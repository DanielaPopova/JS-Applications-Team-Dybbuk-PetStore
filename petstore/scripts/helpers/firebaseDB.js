...
const database = (() => {
    ...
    function getDogBreedDetails(id) {
    ...
    function getCatBreedDetails(id) {
   ...
   function getCatFood(filter) {
    ...
    function getDogAccessoryDetails(id) {
    ...
    function getCatAccessoryDetails(id) {
    ...
    function getDogQuizResults(filter) {
    ...
    function getCatQuizResults(filter) {
    ...
    return {
        ...
        getCatFood,
        getCatFoodDetails,
        getAllDogAccessories,
        getDogAccessoryDetails,
        getAllCatAccessories,
        getCatAccessoryDetails,
        getDogQuizResults,
        getCatQuizResults
    }
